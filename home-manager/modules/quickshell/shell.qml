    ...
    RowLayout {
        ...
        Repeater {
            ...
            Text {
                ...
                font { family: root.family; pixelSize: root.fontSize; bold: true }
        ...
        Text {
            property string dateFormat: "ddd, dd.MM HH:mm"
            ...
            Timer {
                ...
                running: true
                repeat: true
                onTriggered: clock.text = Qt.formatDateTime(new Date(), dateFormat)
            }
        }
    }
}